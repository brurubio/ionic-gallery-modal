(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ionic-angular/index'), require('rxjs/Subject')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'ionic-angular/index', 'rxjs/Subject'], factory) :
	(factory((global['ionic-gallery-modal'] = {}),global._angular_core,global.ionicAngular_index,global.rxjs_Subject));
}(this, (function (exports,_angular_core,ionicAngular_index,rxjs_Subject) { 'use strict';
...
var ZoomableImage = (function () {
    ...
    ZoomableImage.prototype.attachEvents = function () {
        var _this = this;
        // Gesture events
        this.gesture = new ionicAngular_index.Gesture(this.container.nativeElement);
        this.gesture.listen();
...
ZoomableImage.propDecorators = {
    'image': [{ type: _angular_core.ViewChild, args: ['image',] },],
    'container': [{ type: _angular_core.ViewChild, args: ['container',] },],
